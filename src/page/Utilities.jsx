...
function Utilities({title, content, color}) {
  return (
        <div data-aos="zoom-in" data-aos-duration="600" className=' rounded-[2.5rem] w-[400px] bg-[#262626] py-6 px-11 hover:ring z-10'>
            {/* <img src={logo} data-aos="slide-up" data-aos-delay="600" alt="" className='mx-auto h-[150px]'/> */}
            <h4 data-aos="slide-up" data-aos-delay="700" className={'text-semibold text-2xl text-main-color my-3'}>{title}</h4>
